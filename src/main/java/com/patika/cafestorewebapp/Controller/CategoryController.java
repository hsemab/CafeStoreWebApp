...
public class CategoryController {
    ...
    @PostMapping("/add")
    public ResponseEntity<Result> add(@RequestBody CategoryAddDto categoryAddDto) {
    ...
    @PostMapping("/update")
    public ResponseEntity<Result> updateCategory(@RequestBody CategoryUpdateDto categoryUpdateDto){
